...
output: generate_consensus_gene_list.html
...
# Merge into one list:
stress_genes <- c(top_block_genes_env_not_phen,
                  middle_block_genes_phen_and_env)
length(stress_genes)
...
# Merge into one list:
osm_env_response_genes<- c(bottom_block_genes_env_not_phen,
                           top_block_genes_phen_and_env)
...
Save as R object for loading into Manhattan plot:

```{r, message = FALSE}
save.image(file = "results/consensus_gene_list.RData")
```
